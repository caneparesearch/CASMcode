...
namespace CASM {
  ...
  /// \endcode
  ///
  DataFormatter<ConstMonteCarloPtr> make_results_formatter(const ChargeNeutralGrandCanonical &mc) {
    ...
    formatter.push_back(MonteCarloTFormatter<ChargeNeutralGrandCanonical>());
    ...
    {
      formatter.push_back(MonteCarloBetaFormatter<ChargeNeutralGrandCanonical>());
    ...
    for(int i = 0; i < mc.primclex().composition_axes().independent_compositions(); ++i) {
      formatter.push_back(MonteCarloParamChemPotFormatter<ChargeNeutralGrandCanonical>(mc, i));
    }
    ...
    formatter.push_back(MonteCarloHeatCapacityFormatter<ChargeNeutralGrandCanonical>());
    ...
    for(int i = 0; i < mc.primclex().composition_axes().independent_compositions(); i++) {
      for(int j = i; j < mc.primclex().composition_axes().independent_compositions(); j++) {
        ...
        formatter.push_back(MonteCarloSuscXFormatter<ChargeNeutralGrandCanonical>(comp_var_i, comp_var_j));
    ...
    for(int i = 0; i < mc.primclex().composition_axes().independent_compositions(); i++) {
      ...
      auto comp_var_i = mc.primclex().composition_axes().comp_var(i);
      formatter.push_back(MonteCarloThermoChemSuscXFormatter<ChargeNeutralGrandCanonical>(comp_var_i));
    ...
    for(int i = 0; i < struc_mol_name.size(); ++i) {
      for(int j = i; j < struc_mol_name.size(); ++j) {
        ...
        formatter.push_back(MonteCarloSuscNFormatter<ChargeNeutralGrandCanonical>(species_i, species_j));
    ...
    for(int i = 0; i < struc_mol_name.size(); ++i) {
      ...
      auto species_i = struc_mol_name[i];
      formatter.push_back(MonteCarloThermoChemSuscNFormatter<ChargeNeutralGrandCanonical>(species_i));
  ...
  /// \endcode
  ///
  DataFormatter<ConstMonteCarloPtr> make_lte_results_formatter(const ChargeNeutralGrandCanonical &mc, const double &phi_LTE1, const std::string &configname) {
    ...
    formatter.push_back(MonteCarloTFormatter<ChargeNeutralGrandCanonical>());
    formatter.push_back(ChargeNeutralGrandCanonicalLTEFormatter(phi_LTE1));
    std::set<std::string> exclude;
    std::string name;
    ...
    // always sample Beta, potential_energy, and formation_energy
    {
      ...
      auto evaluator = [ = ](const ConstMonteCarloPtr & ptr) {
        return static_cast<const ChargeNeutralGrandCanonical *>(ptr)->potential_energy();
      };
...

    {
      ...
      auto evaluator = [ = ](const ConstMonteCarloPtr & ptr) {
        return static_cast<const ChargeNeutralGrandCanonical *>(ptr)->formation_energy();
      };
      formatter.push_back(GenericDatumFormatter<double, ConstMonteCarloPtr>(name, name, evaluator));
      exclude.insert(name);
    }
    ...
    for(int i = 0; i < mc.primclex().composition_axes().independent_compositions(); i++) {
      ...
      auto evaluator = [ = ](const ConstMonteCarloPtr & ptr) {
        const ChargeNeutralGrandCanonical *_ptr = static_cast<const ChargeNeutralGrandCanonical *>(ptr);
    ...
    for(int i = 0; i < struc_mol_name.size(); ++i) {
      ...
      auto evaluator = [ = ](const ConstMonteCarloPtr & ptr) {
        return static_cast<const ChargeNeutralGrandCanonical *>(ptr)->comp_n()[i];
      };
      formatter.push_back(GenericDatumFormatter<double, ConstMonteCarloPtr>(name, name, evaluator));
      exclude.insert(name);
    }
  ...
  /// \brief Store ChargeNeutralGrandCanonicalConditions in JSON format
  ///
  /// \code
  /// {
  ///   "temperature" : number,
  ...
  GenericDatumFormatter<double, ConstMonteCarloPtr> ChargeNeutralGrandCanonicalLTEFormatter(const double &phi_LTE1) {
  ...
  void write_lte_results(const MonteSettings &settings, const ChargeNeutralGrandCanonical &mc, const double &phi_LTE1, const std::string &configname, Log &_log) {
    try {
