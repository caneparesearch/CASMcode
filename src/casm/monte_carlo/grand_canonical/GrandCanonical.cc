...
namespace CASM {
  ...
  /// - Does not set 'state': conditions or ConfigDoF
    ...
    // Hengning add here, in prim_beta.csv and prim_alpha.csv, formation energy of vibration free energies (Fvib) of ground-state structures are provided, in 4 formula units, same as prim.cif
    ...
    // for docker at orion (test gcMC extract and interpolate Fvib correctly)
